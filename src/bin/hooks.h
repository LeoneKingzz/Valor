...
namespace hooks
{
	...
	private:
		...
		typedef RE::BSEventNotifyControl (on_animation_event::*FnProcessEvent)(RE::BSAnimationGraphEvent& a_event, RE::BSTEventSource<RE::BSAnimationGraphEvent>* dispatcher);
		...
		{
			FnProcessEvent fn = SafeWrite64Function(ptr + 0x8, &on_animation_event::HookedProcessEvent);
